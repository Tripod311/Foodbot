...
/get_rating - вывести рейтинг продуктов (удобно для сравнения), рейтинг вычисляется на основе количества нутриентов в продукте и процента в суточной норме
/get_csv - получить csv таблицу со всеми продуктами и нутриентами"""
    )
